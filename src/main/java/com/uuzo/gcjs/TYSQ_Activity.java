...
public class TYSQ_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tysq);
        ...
        FragmentList.clear();
        FragmentList.add(new TYSQ_Fragment_1());
        FragmentList.add(new TYSQ_Fragment_2());
