 ...
 * 工程标段
 */
public class ProjectChoicean1AdapterM extends BaseAdapter {
    private List<Member.ContentBean> lists = new ArrayList<>();
    private Context context;

    public ProjectChoicean1AdapterM(Context context, List<Member.ContentBean> lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.big.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("projectpm",lists.get(positions).getUnit_name() );
                editor.commit();
