 ...
 * 工程标段
 */
public class ProjectChoicean7AdapterM extends BaseAdapter {
    private List<Member.ContentBean> lists = new ArrayList<>();
    private Context context;

    public ProjectChoicean7AdapterM(Context context, List<Member.ContentBean> lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.big.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("em",lists.get(positions).getUnit_name() );
                editor.commit();
