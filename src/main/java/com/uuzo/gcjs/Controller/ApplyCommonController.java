...
public class ApplyCommonController {
     ...
     * 任务列表
     */
    public static void getTask(Map<String, RequestBody> map, List<MultipartBody.Part> parts, final InterfaceManger.OnRequestListener listener) {
        Call<ResponseBody> call = RetrofitUtils.getInstance().getTask(map, parts);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (status) {
                        listener.onSuccess(new Gson().fromJson(body, ApplyCommon.class));
                    } else {
