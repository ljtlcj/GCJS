...
public class SelectBuMenActivity extends Activity {
			...
			switch (msg.what)
			{
				case 0:
					try
					{
                        ...
                        _WebView.setWebViewClient(new WebViewClient() {
                            ...
                            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                                ...
                                if (!getIntent().getBooleanExtra("ClickLinkNewWeb", false)) {
                                    ...
                                    Intent _Intent = new Intent(ThisContext, SelectBuMenActivity.class);
                        ...
                        _WebView.addJavascriptInterface(new AndroidtoJs(), "WebViewJavascriptBridge");
                        _WebView.addJavascriptInterface(new AndroidtoJs(), "WVJBCallbacks");
    ...
    class AndroidtoJs extends Object {
        ...
        public void registerAction(String msg) {
            ...
            new MessageBox().Show(ThisContext, getString(R.string.Tip), "JS调用了Android的方法"+msg, "", getString(R.string.OK));
