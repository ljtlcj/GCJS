...
import com.uuzo.gcjs.Adapter.Project.ProjectMan.ProjectChoicean6AdapterM;
...
public class ProjectMan6Activity extends BaseActivity {
    private ListView lv_listview;//展示列表
    private List<Member.ContentBean> lists = new ArrayList<Member.ContentBean>();//listview数据集
    private ProjectChoicean6AdapterM adapter;//适配器
    @Override
    public int getLayoutId() {
        return  R.layout.activity_man_choice6;
    }
    ...
    private void init() {
        ...
        ProjectNewController.choice(params, parts, new InterfaceManger.OnRequestListener() {
            ...
            public void onSuccess(Object success) {
                ...
                adapter = new ProjectChoicean6AdapterM(ProjectMan6Activity.this,workTaskProjectMessage.getContent());
