...
import com.uuzo.gcjs.Adapter.Project.ProjectMan.ProjectChoicean7AdapterM;
...
public class ProjectMan7Activity extends BaseActivity {
    private ListView lv_listview;//展示列表
    private List<Member.ContentBean> lists = new ArrayList<Member.ContentBean>();//listview数据集
    private ProjectChoicean7AdapterM adapter;//适配器
    @Override
    public int getLayoutId() {
        return  R.layout.activity_man_choice7;
    }
    ...
    private void init() {
        ...
        ProjectNewController.choice(params, parts, new InterfaceManger.OnRequestListener() {
            ...
            public void onSuccess(Object success) {
                ...
                adapter = new ProjectChoicean7AdapterM(ProjectMan7Activity.this,workTaskProjectMessage.getContent());
