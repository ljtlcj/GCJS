...
public class RegActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            File _File = new File(Config.DirPath(ThisContext));
        ...
        FragmentList.clear();
        FragmentList.add(new Reg_Company_Fragment());
        FragmentList.add(new Reg_Personal_Fragment());
        FragmentList.add(new Reg_Vehicle_Fragment());
        FragmentList.add(new Reg_QiXie_Fragment());
