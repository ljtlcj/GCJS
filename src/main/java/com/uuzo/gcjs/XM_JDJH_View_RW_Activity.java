...
public class XM_JDJH_View_RW_Activity extends Activity {
    ...
    LinearLayout widget_1,widget_2,widget_3,widget_4,widget_5,widget_6,widget_7,widget_8,widget_9,widget_10,widget_11,widget_12,widget_13,widget_14;
	ClsClass.Cls _Cls;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
	    ...
	    setContentView(R.layout.activity_xm_jdjh_view_rw);
        ...
        widget_14.getChildAt(0).setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v) {
        ...
        widget_14.getChildAt(1).setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v) {
                if (_Cls.Int_9!=2){
                    new MessageBox().Show(ThisContext, "提示", "请先"+((TextView)widget_14.getChildAt(2)).getText().toString(), "", getString(R.string.OK));
                    return;
                }

                startActivity(new Intent(ThisContext, XM_JDJH_View_RW_FKList_Activity.class));
            }
        });
        widget_14.getChildAt(2).setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v) {
                if (_Cls.Int_9!=1){
                    new MessageBox().Show(ThisContext, "提示", "请先"+((TextView)widget_14.getChildAt(0)).getText().toString(), "", getString(R.string.OK));
                    return;
                }

                startActivity(new Intent(ThisContext, XM_JDJH_View_RW_SelectMember_Activity.class));
	...
	void UpdateInfo(){
        ...
        ((TextView)widget_2.getChildAt(1)).setText(_Cls.Str_3);
        ((TextView)widget_3.getChildAt(1)).setText(_Cls.Cls_1.Str_2);
        widget_4.setBackgroundResource(R.drawable.itembg);
        Date BeginTime= Common.StrToDate(_Cls.Str_10,"yyyy-MM-dd");
        if (BeginTime==null) {
            BeginTime= Common.StrToDate("1900-01-01","yyyy-MM-dd");
            try {
                BeginTime.setTime(Long.valueOf(_Cls.Str_10) * 1000);
            } catch (Exception e1) {
                BeginTime = Common.StrToDate("1900-01-01", "yyyy-MM-dd");
            }
        }
        ...
        Date EndTime= Common.StrToDate(_Cls.Str_11,"yyyy-MM-dd");
        if (EndTime==null) {
            EndTime= Common.StrToDate("1900-01-01","yyyy-MM-dd");
            try {
                EndTime.setTime(Long.valueOf(_Cls.Str_11) * 1000);
            } catch (Exception e1) {
                EndTime = Common.StrToDate("1900-01-01", "yyyy-MM-dd");
            }
        }
        ...
        ((TextView)widget_6.getChildAt(1)).setText(String.valueOf(_Cls.Int_5)+"天");
        ((TextView)widget_7.getChildAt(1)).setText(String.valueOf(_Cls.Int_4)+_Cls.Str_4);
        ((TextView)widget_8.getChildAt(1)).setText(_Cls.Str_6);
        ((TextView)widget_9.getChildAt(1)).setTag(_Cls.Str_8);
        ((TextView)widget_9.getChildAt(1)).setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v) {
        ...
        ((TextView)widget_10.getChildAt(1)).setText(_Cls.Int_6+"%");
        String FZR="";
        for (int i=0;i<_Cls.Cls_1.ClsList_1.size();i++){
            if (!FZR.equals("")) FZR+="，";
            FZR+=_Cls.Cls_1.ClsList_1.get(i).Str_1;
        }
        ((TextView)widget_11.getChildAt(1)).setText(FZR);
        ...
        ((TextView)widget_14.getChildAt(0)).setText(_Cls.Int_9==0?"编制计划":"变更计划");
        ((TextView)widget_14.getChildAt(1)).setBackgroundResource(_Cls.Int_9==2? R.drawable.btnbg_blue: R.drawable.btnbg_gray);
        ((TextView)widget_14.getChildAt(2)).setBackgroundResource(_Cls.Int_9==1? R.drawable.btnbg_blue: R.drawable.btnbg_gray);
			...
			if (FunName.equals("toPlan")) {
                try {
                    ...
                    if (_JSONObject.getBoolean("status")) {
                        ...
                        Common.DisplayToast(_Cls.Int_9==0?"编制成功":"变更成功");
                        ...
                        _Cls.Int_9=1;
                        _Cls.Str_10=String.valueOf(BeginDate.getTime()/1000);
                        _Cls.Str_11=String.valueOf(EndDate.getTime()/1000);
                        _Cls.Int_5=Long.valueOf(((EndDate.getTime()-BeginDate.getTime())/1000/3600/24)+1).intValue();
