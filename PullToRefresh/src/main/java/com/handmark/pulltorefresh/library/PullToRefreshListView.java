...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	{
		if (mRefreshableView==null) return null;
	...
	{
		if (mRefreshableView==null) return 0;
		return mRefreshableView.getDividerHeight();
	}

	public Boolean IsNotScorll=false;//设置不滚动

    public int getAndSetTotalHeight(int num) {
        try {
            ListAdapter mAdapter = getAdapter();
            if (mAdapter == null || getVisibility()==GONE) return 0;
            ...
            params.height = totalHeight + (getDividerHeight() * (mAdapter.getCount() - 1))+num;
    ...
    public View getViewByPosition(int pos) {
        int firstListItemPosition = super.mRefreshableView.getFirstVisiblePosition();
        int lastListItemPosition = firstListItemPosition + super.mRefreshableView.getChildCount() - 1;
