...
//			}
	...
	@Override
	public final void setAnimationStyle(AnimationStyle _AnimationStyle) {
		if (_AnimationStyle != mLoadingAnimationStyle) {
//			if (DEBUG) {
//				Log.d(LOG_TAG, "Setting AnimationStyle to: " + _AnimationStyle);
//			}
			mLoadingAnimationStyle = _AnimationStyle;
			//updateUIForMode();
		}
	}
